package com.crom.miguiapp.services;
...
import com.crom.miguiapp.AudioActivity;
import com.crom.miguiapp.R;
import com.crom.miguiapp.task.PlayBackTask;

import java.io.IOException;

/**
 * Created by Cristobal Romero on 25/09/2016.
 */
public class MediaPlayerService extends Service implements MediaPlayer.OnPreparedListener {
    ...
    public void onCreate() {
        super.onCreate();
        mediaPlayer = MediaPlayer.create(this, R.raw.maluma_el_perdedor);
    }
